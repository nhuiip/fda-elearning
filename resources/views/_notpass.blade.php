<div class="row text-center mb-5">
    <h3 class="display-4 mb-3 px-xl-10 mb-0">ยังไม่ผ่านเกณฑ์: {{ $lesson->name }}</h3>
    ...
    <p class="mb-0">จำนวนข้อสอบที่ทำถูกต้องทั้งหมด: <span class="text-danger"
            style="font-size: 1.5rem"><strong>{{ $countRight }}</strong></span> ข้อ</p>
    <p class="mb-0">คะแนนที่ได้: <span class="text-danger"
            style="font-size: 1.5rem"><strong>{{ $exam->score }}</strong></span> คะแนน</p>
    <p class="mb-5">คิดเป็น: <span class="text-danger"
